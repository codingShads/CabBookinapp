<%-- 
    Document   : customerBoard
    Created on : Sep 21, 2022, 8:21:55 AM
    Author     : ThileebanS
--%>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="people">
                                <img src="" alt="">
                                <div class="people-de">
                                    <h5><% out.print(rs.getString("cusname"));%></h5>
                                    <p>john@example.com</p>
                                </div>
                            </td>
                            <td class="people-des">
                                <h5><% out.print(rs.getString("cusmobile"));%></h5>
                                <p>Web dev</p>
                            </td>
                            <td class="active">
                                <p><% out.print(rs.getString("cusmobile"));%></p>
                            </td>
                            <td class="role">
                                <p>owner</p>
                            </td>
